				...
				<div className="meet-wrap">
					<div className="meet-left">
						<p className="meet-left-img">
							<Image
								loader={myLoader}
								src={`${process.env.NEXT_PUBLIC_STRAPI_API_URL}${meettheteam.attributes.memberImageURL}`}
						...
						<a className="number" href={`tel:${encodeURIComponent(meettheteam.attributes.contactNo)}`}>{meettheteam.attributes.contactNo}</a>
						<a className="email" href={`mailto:${encodeURIComponent(meettheteam.attributes.memberEmail)}`}>{meettheteam.attributes.memberEmail}</a>
					</div>
